...
class RAFT(
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.args.dim = 128
        self.block_dims = [63, 128, 256]
        self.output_dim = 128 * 2
        
        self.args.corr_levels = 4
        self.args.corr_radius = 4
        self.args.corr_channel = args.corr_levels * (4 * 2 + 1) ** 2
